...
const ManageItems = () => {
  ...
  //STATE VARIABLES FOR EDITABLE INFORMATION
  const [editedProductName, setEditedProductName] = useState('');
  const [editedProductCategory, setEditedProductCategory] = useState('');
  const [editNumOfProducts, setEditedNumOfProducts] = useState('');
  ...
  return (
    <div className='flexcd flex-col text-center pt-4 mt-2 pr-5 mt-3 mb-1 w-full pr-3' style={{ backgroundColor: 'white', boxShadow: '0 4px 8px rgba(0, 0, 1, 0.1)' }}>
      <div>
        <div>
  ...
  <div className="item-details">
    ...
    <div className="w-[1096px] h-[809px] relative bg-white rounded-lg">
    ...
    <div className="left-[283px] top-[530px] absolute text-gray-500 text-sm font-medium font-poppins text-black leading-tight">{renderTotalPrice()} </div>
  ...
  <div className="left-[703px] top-[183px] absolute text-gray-400 text-base font-normal font-poppins text-black leading-normal">Spllier Name</div>
    {/* <div className="left-[43px] top-[641px] absolute text-gray-400 text-base font-normal font-poppins text-black leading-normal">RRR </div> */}
    <div className="left-[283px] top-[183px] absolute text-gray-500 text-sm font-medium font-poppins text-black leading-tight">{itemInfo.productName}</div>
    <div className="left-[883px] top-[183px] absolute text-gray-500 text-sm font-medium font-poppins text-black leading-tight">{companyInfo.supplier}</div>
    {/* <div className="left-[668px] top-[641px] absolute text-blue-600 text-sm font-medium font-poppins text-black leading-tight">15</div> */}
    ...
    {/* <div className="left-[43px] top-[693px] absolute text-gray-400 text-base font-normal font-poppins text-black leading-normal">SSS</div> */}
    ...
    <div className="left-[883px] top-[287px] absolute text-gray-500 text-sm font-medium font-poppins text-black leading-tight">{companyInfo.mailingName}</div>
    ...
    <div className="left-[883px] top-[339px] absolute text-gray-500 text-sm font-medium font-poppins text-black leading-tight">{companyInfo.address}</div>
    ...
    <div className="left-[883px] top-[400px] absolute text-gray-500 text-sm font-medium font-poppins text-black leading-tight">{companyInfo.state}</div>
    ...
    <div className="left-[883px] top-[460px] absolute text-gray-500 text-sm font-medium font-poppins text-black leading-tight">{companyInfo.country}</div>


    <div className="left-[283px] top-[235px] absolute text-gray-500 text-sm font-medium font-poppins text-black leading-tight">{itemInfo.refNumber}</div>
    <div className="left-[883px] top-[235px] absolute text-gray-500 text-sm font-medium font-poppins text-black leading-tight">{companyInfo.companyName}</div>
    {/* <div className="left-[668px] top-[693px] absolute text-blue-600 text-sm font-medium font-poppins text-black leading-tight">19</div> */}
    ...
    <div className="left-[283px] top-[287px] absolute text-gray-500 text-sm font-medium font-poppins text-black leading-tight">{itemInfo.productCategory}</div>
    ...
    <div className="left-[283px] top-[339px] absolute text-gray-500 text-sm font-medium font-poppins text-black leading-tight">{formatExpiryDate(itemInfo.productExpiryDate)}</div>
    ...
    <div className="left-[43px] top-[591px] absolute text-gray-500 text-sm font-semibold font-poppins text-black leading-tight">Store Name</div>
