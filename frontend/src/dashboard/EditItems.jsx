...
const EditItems = () => {
  ...
  <h5 className="font-poppins text-[#000000] font-bold mb-4 text-center">Update The Item</h5>
</div>
    <form onSubmit={handleUpdate}>
            <div className="row g-3">
              <div className="col-md-6">
                <label className="label-style font-poppins font-bold" htmlFor="refNumber" >Product Reference Number</label>
              ...
              <div className="col-12">
                <label className="label-style font-poppins font-bold" htmlFor="productDescription" >Product Decription</label>
              ...
              <div className="col-md-6">
                <label className="label-style font-poppins font-bold" htmlFor="productCategory" >Product Category</label>
              ...
              {/* <div className="col-md">
                <label className="label-style font-poppins font-bold" htmlFor="month" id='month' name="month">Entry Month</label>
...
<div className="col-md">
  <label className="label-style font-poppins font-bold" htmlFor="month">
    Entry Month
  </label>
  <div className="position-relative">
    ...
    >
      ...
      <span className="dropdown-wrapper" aria-hidden="true"></span>
              ...
              <div className="col-md-6">
                <label className="label-style font-poppins font-bold" htmlFor="productEntryDate">Product Entry Date</label>
 ...
 onChange={e=> setValues({...values,productEntryDate:e.target.value})} />
              ...
              <div className="col-md-6">
                <label className="label-style font-poppins font-bold" htmlFor="productExpiryDate">Product Expiry Date</label>
 ...
 onChange={e=> setValues({...values,productExpiryDate:e.target.value})} />
              ...
              <div className="col-md-6">
                <label className="label-style font-poppins font-bold" htmlFor="numOfProducts">Number of Products</label>
              ...
              <div className="col-md-6">
                <label className="label-style font-poppins font-bold" htmlFor="tax">tax</label>
              ...
              {/* <div className="col-md">
                <label className="label-style font-poppins font-bold" htmlFor= "totalPrice">Total Price</label>
