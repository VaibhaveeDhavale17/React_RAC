    ...
    <form onSubmit={handleUpdate}>
            <div className="row g-3">
              ...
              <div className="col-md-6">
                ...
                <input type="text" id="productEntryDate" name="productEntryDate" className="form-control phone-mask" placeholder="" value={values.productEntryDate} onChange={e=> setValues({...values,productEntryDate:e.target.value})} />
              </div>

              <div className="col-md-6">
                <label className="form-label font-poppins text-[#000000] font-bold" htmlFor="productExpiryDate">Product Expiry Date</label>
                <input type="text" id="productExpiryDate" name="productExpiryDate" className="form-control phone-mask" placeholder="" value={values.productExpiryDate} onChange={e=> setValues({...values,productExpiryDate:e.target.value})} />
              </div>
